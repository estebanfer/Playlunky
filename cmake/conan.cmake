...
macro(run_conan)
    ...
    cmake_path(SET pl_conan_build_profile "${CMAKE_CURRENT_SOURCE_DIR}/cmake/conan_build_profile")
    set(CONAN_HOST_PROFILE "${pl_conan_build_profile};auto-cmake" CACHE STRING "Conan host profile" FORCE)
